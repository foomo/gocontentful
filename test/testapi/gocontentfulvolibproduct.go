// Code generated by https://github.com/foomo/gocontentful v1.0.12 - DO NOT EDIT.
package testapi
	...
	for _, loc := range cc.locales {
		...
		if okChildren {
			for _, child := range children {
				...
				newParentRef := EntryReference{ContentType: product.Sys.ContentType.Sys.ID, ID: product.Sys.ID, VO: product}
