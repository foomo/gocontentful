// Code generated by https://github.com/foomo/gocontentful v1.1.0 - DO NOT EDIT.
package testapi
	...
	for {
		...
		for _, entry := range entries {
			...
			case sysTypeEntry:
				...
				errUpdate := updateCacheForContentTypeAndEntity(ctx, cc, entry.Sys.ContentType.Sys.ID, entry.Sys.ID, entry, false)
			...
			case sysTypeDeletedEntry:
				...
				errUpdate := updateCacheForContentTypeAndEntity(ctx, cc, contentType, entry.Sys.ID, entry, true)
				if errUpdate != nil && cc.logFn != nil && cc.logLevel <= LogInfo {
					cc.logFn(map[string]interface{}{"task": "syncCache", "error": errUpdate, "op": "delete", "entryId": entry.Sys.ID},
						LogWarn, ErrorEntryCachingFailed)
				} else {
		...
		for _, asset := range assets {
			...
			case sysTypeAsset:
				errUpdate := updateCacheForContentTypeAndEntity(ctx, cc, assetWorkerType, asset.Sys.ID, asset, false)
				if errUpdate != nil && cc.logFn != nil && cc.logLevel <= LogInfo {
			...
			case sysTypeDeletedAsset:
				errUpdate := updateCacheForContentTypeAndEntity(ctx, cc, assetWorkerType, asset.Sys.ID, nil, true)
				if errUpdate != nil && cc.logFn != nil && cc.logLevel <= LogInfo {
...
func commonGetParents(cc *ContentfulClient, id string, contentTypes []string) (parents []EntryReference, err error) {
