// Package testapi - DO NOT EDIT THIS FILE: Auto-generated code by https://github.com/foomo/gocontentful v1.0.12
package testapi
...
func (cc *ContentfulClient) UpdateCache(ctx context.Context, contentTypes []string, cacheAssets bool) error {
	...
	if cc.sync {
		return cc.syncCache(ctx, contentTypes)
	}
...
func updateCacheForContentTypeAndEntity(ctx context.Context, cc *ContentfulClient, contentType string, entityID string, entityPayload interface{}, entryDelete bool) error {
	...
	case assetWorkerType:
		if entryDelete {
			...
			err := cc.cacheGcAssetByID(ctx, entityID, entityPayload.(*contentful.Asset))
			if err != nil {
				return err
			}
		}
	...
	case ContentTypeBrand:
		err := cc.cacheBrandByID(ctx, entityID, entityPayload.(*contentful.Entry), entryDelete)
		if err != nil {
			return err
		}
		if cc.logFn != nil && cc.logLevel <= LogInfo && entityPayload == nil {
	...
	case ContentTypeCategory:
		err := cc.cacheCategoryByID(ctx, entityID, entityPayload.(*contentful.Entry), entryDelete)
		if err != nil {
			return err
		}
		if cc.logFn != nil && cc.logLevel <= LogInfo && entityPayload == nil {
	...
	case ContentTypeProduct:
		err := cc.cacheProductByID(ctx, entityID, entityPayload.(*contentful.Entry), entryDelete)
		if err != nil {
			return err
		}
		if cc.logFn != nil && cc.logLevel <= LogInfo && entityPayload == nil {
